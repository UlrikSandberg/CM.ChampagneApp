...
[assembly: ExportRenderer(typeof(CM.ChampagneApp.UI.CustomLayouts.CustomScrollView), typeof(ExtendedScrollViewRenderer))]
namespace CM.ChampagneApp.iOS.Renderers
{
    public class ExtendedScrollViewRenderer : ScrollViewRenderer
    {
        ...
        {
            iosScrollView = (UIScrollView)NativeView;
			iosScrollView.ContentInset = new UIEdgeInsets(-20, 0, 0, 0);
			iosScrollView.ShowsHorizontalScrollIndicator = false;
            iosScrollView.ShowsVerticalScrollIndicator = false;         
        }
    }
